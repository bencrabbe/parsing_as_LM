...
if __name__ == '__main__':
    ...
    parser = LCmodel(train_df,rnn_memory=1500,embedding_size=300,device=3)
    parser.cuda(device=3)
    parser.train(train_df,dev_df,200,batch_size=128,learning_rate=2.0,device=3,alpha=0.0) 
