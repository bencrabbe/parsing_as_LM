...
if __name__ == '__main__':
    ...
    parser = LCmodel(train_df,rnn_memory=1500,embedding_size=100,device=1)
    parser.cuda(device=1)
    parser.train(train_df,dev_df,200,batch_size=128,learning_rate=3.0,device=1,alpha=0.0) 
