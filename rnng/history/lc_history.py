...
if __name__ == '__main__':
    ...
    vocab = Vocabulary(extract_vocabulary('/home/bcrabbe/parsing_as_LM/rnng/history/billion_words'))
    vocab.save('toto')
    ...
    parser = LCmodel(train_df,rnn_memory=600,embedding_size=50,device=3)
