...
class LCmodel(nn.Module):
    ...
    def train_language_model(self,train_set,dev_set,epochs,batch_size=64,learning_rate=1.0,device=-1,alpha=0.0,clip=0.5,save_path='default'):
        """
        ...
        scheduler = LambdaLR(optimizer,lr_lambda=lambda epoch:learning_rate/(1+epoch)**0.5)
        min_ppl   = 10000000000
