...
if __name__ == '__main__':
    ...
    parser = LCmodel(train_df,rnn_memory=1500,embedding_size=100,device=2)
    parser.cuda(device=2)
    parser.train(train_df,dev_df,200,batch_size=128,learning_rate=0.1,device=2,alpha=0.0) 
