...
if __name__ == '__main__':
    ...
    rnnlm.train_rnn_lm('testlm',train_treebank,dev_treebank,lr=0.0001,dropout=0.5,batch_size=100,max_epochs=150,cls_filename='ptb-1000.brown',w2v_file='word_embeddings/w2v-ptb.txt')    
